...
import { Player, Enemy, Item, ItemType } from '../shared/types';
...
export class PlayerEntity implements Player {
  ...
  gainExperience(amount: number): void {
    ...
    const expToLevelUp = 100 * this.level;
...
export class EnemyEntity implements Enemy {
  ...
  private getStatsForType(
    ...
    const stats = {
      goblin: { maxHealth: 20, damage: 3, speed: 80 },
      orc: { maxHealth: 40, damage: 6, speed: 100 },
      troll: { maxHealth: 80, damage: 10, speed: 60 },
      dragon: { maxHealth: 150, damage: 15, speed: 120 },
    };
